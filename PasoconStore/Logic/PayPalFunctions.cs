...
namespace PasoconStore.Logic
{
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "sb-ib6uq29061740_api1.business.example.com";
        private string APIPassword = "95ZMPHBJ3K2AL2MD";
        private string APISignature = "AWevIju97o6HpxQXGkFfdN152uXzAxdm7wJXVd3tJi9tdIlH-KxIPwQL";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            string returnURL = "https://localhost:44323/Checkout/CheckoutReview.aspx";
            string cancelURL = "https://localhost:44323/Checkout/CheckoutCancel.aspx";
            ...
            using (PasoconStore.Logic.ShoppingCartActions myCartOrders = new PasoconStore.Logic.ShoppingCartActions())
            {
